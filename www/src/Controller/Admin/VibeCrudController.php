...
class VibeCrudController extends AbstractCrudController
{
    ...
    public function configureCrud(Crud $crud): Crud
    {
        ...
        return $crud
            ->setPageTitle(Crud::PAGE_INDEX, 'Liste des ambiances')
            ->setPageTitle(Crud::PAGE_NEW, 'Ajouter une ambiance')
            ->setPageTitle(Crud::PAGE_EDIT, 'Modifier une ambiance');
    }
